                            ...
                            <form action="{{ url('admin/jobs/add') }}" class="form-horizontal" method="post"
                                ...
                                <div class="card card-body">
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Jobs Title
                                            <span style="color: red;">*</span></label>
                                        <div class="col-sm-10">
                                            <input type="text" value="{{ old('job_title') }}" name="job_title"
                                                class="form-control" required placeholder="Team Lead">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" value="{{ old('min_salary') }}" name="min_salary"
                                                class="form-control" required placeholder="65000">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" value="{{ old('max_salary') }}" name="max_salary"
                                                class="form-control" required placeholder="500000">
                                        </div>
                                    </div>
