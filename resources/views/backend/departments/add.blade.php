                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-info">
                            ...
                            <form action="{{ url('admin/departments/add') }}" class="form-horizontal" method="post"
                                ...
                                <div class="card card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" value="{{ old('department_name') }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select name="manager_id" class="form-control" required>
                                                ...
                                                <option value="1">ChiChi</option>
                                                <option value="2">Emeka</option>
                                            </select>
                                        </div>
                                    </div>
