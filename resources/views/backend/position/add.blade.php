                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-info">
                            ...
                            <form action="{{ url('admin/position/add') }}" class="form-horizontal" method="post"
                                ...
                                <div class="card card-body">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Daily Rate
                                            <span style="color: red;">*</span></label>
                                        <div class="col-sm-10">
                                            <input type="number" value="{{ old('daily_rate') }}" name="daily_rate"
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Monthly Rate
                                            <span style="color: red;">*</span></label>
                                        <div class="col-sm-10">
                                            <input type="number" value="{{ old('monthly_rate') }}" name="monthly_rate"
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Working Days Per Month
                                            <span style="color: red;">*</span></label>
                                        <div class="col-sm-10">
                                            <input type="number" value="{{ old('working_days_per_month') }}"
