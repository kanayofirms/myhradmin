...
<head>
    ...
    <title>Myhradmin | Dashboard</title>
    ...
    <link rel="stylesheet"
        href="{{ url('public/backend/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css') }}">
    <!-- iCheck -->
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <!-- Tempusdominus Bootstrap 4 -->
    <script src="{{ url('public/backend/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js') }}">
    </script>
    <!-- Summernote -->
